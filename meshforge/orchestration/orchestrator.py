...
from meshforge.agents.llm.provider import LLMProvider, create_provider
...
from meshforge.evolution.selection import ParentSelector, EnsembleSelector
...
from meshforge.knowledge.failure_memory import FailureMemory
...
class AgenticOrchestrator:
    ...
    def __init__(
        ...
        self.base_mesh_path: Optional[str] = None
    ...
    async def initialize(
        ...
        Args:
            base_mesh_path: Path to the base .mesh file
    ...
    async def run_generation(self, generation: int) -> GenerationResult:
        ...
        for solution in solutions_to_process:
            ...
            phase4_result = await self.phase4.execute(
                context=self.context,
                solution=solution,
                base_mesh_path=self.base_mesh_path,
    ...
    async def run(
        ...
        # Initialize
        init_result = await self.initialize(base_mesh_path, morphing_config_path)
